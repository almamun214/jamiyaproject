                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="portlet-body form">
                                                            <!-- BEGIN FORM-->
                                                            <form action="{{route('receiveVoucerSave')}}" method="post" class="form-horizontal">
                                                                @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <select name="depositAccount" id="single" class="form-control select2">
                                                                                        <option></option>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" name="account" placeholder="Account" class="form-control" value=""> </div>

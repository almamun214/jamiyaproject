                        ...
                        <div class="portlet box blue-hoki">--}}
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i>Payment Voucher Add
                                    </div>
                                    <div class="actions">
                                                                    ...
                                                                    <div class="form-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">Pay. From ( CR ) *</label>
                                                                                    <div class="col-md-9">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" name="voucherId" class="form-control" readonly value="RV191100001"> </div>
                                                                                </div>
                                                                                <div class="form-group">
